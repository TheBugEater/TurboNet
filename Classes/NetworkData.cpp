...
//Add Values           //////////////////////////////////
/////////////////////////////////////////////////////////
void NetworkData::AddValue(string key,const char *value)
{
	m_valuesString[key] = value;
}

void NetworkData::AddValue(string key,int value)
{
	m_valuesInt[key] = value;
}

void NetworkData::AddValue(string key,float value)
{
	m_valuesFloat[key] = value;
}

void NetworkData::AddValue(string key,bool value)
{
...
//Get Values           //////////////////////////////////
/////////////////////////////////////////////////////////
void NetworkData::GetValue(string key,string &value)
{
	value = m_valuesString[key];
}

void NetworkData::GetValue(string key,int &value)
{
	value = m_valuesInt[key];
}

void NetworkData::GetValue(string key,float &value)
{
	value = m_valuesFloat[key];
}

void NetworkData::GetValue(string key,bool &value)
{
	value = m_valuesBool[key];
}

///////////////////////////////////////////////////////////
void NetworkData::RemoveValue(string key)
{
	//Int
...
const char* NetworkData::GetDataString()
{
	m_string.clear();
...
void NetworkData::InitWithDataString(const char *data)
{
...
vector<string> NetworkData::Parse(string str,string delimeter)
{
